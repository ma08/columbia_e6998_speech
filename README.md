...
- Use a relevant name for the project like `Speech-6998`.
...
Generally the following works:
  ...
  - For example: $ `gcloud compute ssh speech-spring-23 --ssh-key-file=~/.ssh/sk5057 --zone=us-east1-c --project=Speech-6998`
